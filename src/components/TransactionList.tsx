  ...
  return (
    <div className="bg-white p-5 sm:p-7 rounded-[32px] border border-zinc-200/60 shadow-sm h-full flex flex-col relative transition-all duration-300">
      ...
      {(effectivelyFiltered.length > 0 || filteredTransactions.length > 0) && (
        <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mb-6 p-1.5 sm:p-2 bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900 dark:to-emerald-800 rounded-2xl border border-emerald-300 dark:border-emerald-600 shadow-md">
          {/* Income Column */}
          ...
          <div className="flex flex-col items-center text-center p-2 sm:p-3 bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-600 shadow-sm min-w-0">
            ...
            <span className={cn(
              ...
              summary.net >= 0 ? "text-emerald-700 dark:text-emerald-300" : "text-rose-700 dark:text-rose-300"
            )}>
